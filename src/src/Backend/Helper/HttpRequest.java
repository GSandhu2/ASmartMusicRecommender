 ...
 * Make/receive http requests. Throws RuntimeException on error responses or IO errors.
...
public class HttpRequest {
  ...
  public static String getJsonFromUrl(String url, String authorization) throws RuntimeException {
    try {
      ...
      throw new IllegalArgumentException("HttpRequest: Invalid URL - " + e.getMessage());
    } catch (IOException e) {
      throw new RuntimeException("HttpRequest: IOException" + e.getMessage());
    }
  }
  ...
  public static String postAndGetJsonFromUrlBody(String url, String body, String contentType,
      String authorization) throws RuntimeException {
    try {
      HttpsURLConnection connection = (HttpsURLConnection) (new URL(url).openConnection());
